package com.codefish.colortool.hook.android.corepatch;
...
import com.codefish.colortool.BuildConfig;
...
public class CorePatchForR extends XposedHelper implements IXposedHookLoadPackage, IXposedHookZygoteInit {
    ...
    final XSharedPreferences prefs = new XSharedPreferences(BuildConfig.APPLICATION_ID, "android\\package_manager_services");
